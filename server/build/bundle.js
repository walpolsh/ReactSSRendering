...
app.use(_express2.default.static('public')); //tells express to treat the public directory as a static or public directory thats available to the outside world.
app.get('/', function (req, res) {
  //root route
  res.send((0, _renderer2.default)()); //send component when root route is requested
});
